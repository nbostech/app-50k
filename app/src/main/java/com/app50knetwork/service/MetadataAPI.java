...
public class MetadataAPI {
    ...
    public static void getCompCategories(final Context context, final AppCallback appCallback){
    ...
    public static void getCompStages(final Context context, final AppCallback appCallback){
        String token = Prefrences.getClientToken(context);
    ...
    public static void getAssociateTypes(final Context context, final AppCallback appCallback){
        String token = Prefrences.getClientToken(context);
