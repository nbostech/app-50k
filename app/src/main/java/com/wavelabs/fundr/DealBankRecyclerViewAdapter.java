...
import com.wavelabs.fundr.DealBankFragment.OnDealBankListFragIListener;
 ...
 * specified {@link OnDealBankListFragIListener}.
 * TODO: Replace the implementation with code for your data type.
 */
public class DealBankRecyclerViewAdapter extends RecyclerView.Adapter<DealBankRecyclerViewAdapter.ViewHolder> {

    private final List<Company> mValues;
    private final DealBankFragment.OnDealBankListFragIListener mListener;

    public DealBankRecyclerViewAdapter(List<Company> items, OnDealBankListFragIListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_dealbank, parent, false);
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onDealBankListFragInteraction(holder.mItem);
                }
            }
        });
    }
