...
//            userNameET.setText(((LoginActivity) getActivity()).appUser.getFullName());
            ...
            public void onClick(View v) {
                if (selectedRoleOption.equalsIgnoreCase("investor")) {
                    ...
                    createAccountForInvestor(userNameET.getText().toString(),
                            ...
                            phoneNumber.getText().toString(), aoiJsonArray, deJsonArray);
    ...
    private void createAccountForInvestor(String fullName, String uuid, String email, String contactNumber, JSONArray aoiJO,JSONArray deJO) {
