...
public class AppUser implements Serializable{
    ...
    private List<MetaDataNameModel> areaofInterests;
    @SerializedName("domainExpertises")
    private List<MetaDataNameModel> domainExpertises;
    ...
    public List<MetaDataNameModel> getDomainExpertises() {
        return domainExpertises;
    }

    public void setDomainExpertises(List<MetaDataNameModel> domainExpertises) {
        this.domainExpertises = domainExpertises;
    }

    public List<MetaDataNameModel> getAreaofInterests() {
        return areaofInterests;
    }

    public void setAreaofInterests(List<MetaDataNameModel> areaofInterests) {
