...
public class UserAPI {
    ...
    public static void createUser(final Context context, final NBOSCallback nbosCallback, AppUser user){
    ...
    public static void getUsers(final Context context,final NBOSCallback nbosCallback,String userType){
    ...
    public static void getUserDetails(final Context context,final NBOSCallback nbosCallback,String userId){
        String token = Prefrences.getClientToken(context);
    ...
    public static void login(final Context context, final NBOSCallback nbosCallback, JsonObject uuid){
        String token =  Prefrences.getAccessToken(context);
    ...
    public static void updateUserProfile(final Context context, final NBOSCallback nbosCallback, Profile profile){
        String token = Prefrences.getAccessToken(context);
